...
''.
'    <title>Admin - Thế giới LapTop</title>'.
...
'    <header > '.
'            <img src="img/logo1.png"style="width:100px ;" alt="Trang chủ LapTop" title="Trang chủ LapTop">'.
'       '.
'    </header>'.
'    <!-- Menu -->'.
'    <aside class="sidebar">'.
...
'                    '.
'                    <!--button onclick="locDonHangTheoKhoangNgay1()"><i class="fa fa-search"></i> Tìm</button-->'.
'                </div>'.
'                '.
'                <select id="Company1" >'.
